    ...
    >
      <defs>
        ...
        <marker id="cpu-circle-marker" viewBox="0 0 10 10" refX="5" refY="5" markerWidth={lineMarkerSize} markerHeight={lineMarkerSize}>
          <circle id="innerMarkerCircle" cx="5" cy="5" r="2" fill="white" stroke="#e2e8f0" strokeWidth="0.5">
      ...
      <g>
        ...
        <rect x="82" y="40" width="36" height="20" rx="2" fill="#1e2937" filter="url(#cpu-light-shadow)" />
        <text x="100" y="52.5" textAnchor="middle" fontSize="7" fill={animateText ? "url(#cpu-text-gradient)" : "white"} fontWeight="600" letterSpacing="0.05em">
          {text}
        </text>
      </g>
    </svg>
